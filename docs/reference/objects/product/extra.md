...
- When accessed through an [experience slot]({% link docs/reference/objects/product/experience_slot.md %}), it will return `true` if the extra has unlimited stock on the given date.
...
- When accessed through an [experience slot]({% link docs/reference/objects/product/experience_slot.md %}), it will return the initial stock for the extra on the given date.
...
- When accessed through an [experience slot]({% link docs/reference/objects/product/experience_slot.md %}), it will return the price for the extra on the given date.
...
- When accessed through an [experience slot]({% link docs/reference/objects/product/experience_slot.md %}), it will return the prices for the extra on the given date.
...
- When accessed through an [experience slot]({% link docs/reference/objects/product/experience_slot.md %}), it will return the remaining stock for the extra on the given date.
...
- When accessed through an [experience slot]({% link docs/reference/objects/product/experience_slot.md %}), it will return `true` if the extra is sold out on the given date.
